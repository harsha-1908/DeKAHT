...
| Groups | Acc | F1 | Precision | Recall |
|-------|-----|----|-----------|--------|
| G=4  | 89.00 | 0.891 | 0.893 | 0.892 |
| **G=8 (default)** | **88.60** | **0.885** | **0.888** | **0.886** |
...
| Groups | Acc | F1 | Precision | Recall |
|-------|-----|----|-----------|--------|
| G=4  | 88.00 | 0.878 | 0.881 | 0.880 |
| **G=8 (default)** | **84.80** | **0.850** | **0.856** | **0.848** |
| G=16 | 89.60 | 0.895 | 0.896 | 0.896 |
| G=32 | **90.20** | **0.901** | **0.903** | **0.902** |
...
| Groups | Acc | F1 | Precision | Recall |
|-------|-----|----|-----------|--------|
| G=4  | **91.20** | **0.910** | **0.911** | **0.912** |
| **G=8 (default)** | **84.00** | **0.839** | **0.843** | **0.840** |
| G=16 | 80.80* | 0.809* | 0.820* | 0.808* |
| G=32 | 91.00 | 0.909 | 0.910 | 0.910 |

\* Base G=16 training incomplete — final metrics pending.
